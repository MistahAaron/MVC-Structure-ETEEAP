...
function renderStudentTables(studentsToRender) {
    ...
    tables.forEach(table => {
        ...
        studentsToRender.forEach(student => {
            ...
            row.innerHTML = `
    <td class="action-buttons">
        <a href="/frontend/AssessorSide/Evaluation/evaluation.html?id=${student._id}" class="action-btn view-btn">
...
function viewStudent(applicantId) {
    window.location.href = `/frontend/AssessorSide/Evaluation/evaluation.html?id=${applicantId}`;
}
